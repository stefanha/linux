...
extern int vt_activate_device (iscsi_device_t *);
extern void vt_deactivate_device (iscsi_device_t *);
extern int vt_check_device_location (iscsi_device_t *, iscsi_dev_transport_info_t *);
