...
extern int rd_activate_device (iscsi_device_t *);
extern void rd_deactivate_device (iscsi_device_t *);
extern int rd_check_device_location (iscsi_device_t *, iscsi_dev_transport_info_t *);
