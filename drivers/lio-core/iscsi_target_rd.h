...
extern int rd_attach_hba (iscsi_portal_group_t *, se_hba_t *, iscsi_hbainfo_t *);
extern int rd_detach_hba (se_hba_t *);
extern int rd_DIRECT_create_virtdevice (se_hba_t *, iscsi_devinfo_t *);
...
extern se_device_t *rd_add_device_to_list (se_hba_t *, void *, iscsi_devinfo_t *);
