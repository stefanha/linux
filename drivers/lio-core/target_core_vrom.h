...
int vr_create_virtdevice (se_hba_t *, se_devinfo_t *);
int vr_activate_device (se_device_t *);
void vr_deactivate_device (se_device_t *);
void vr_free_device (se_device_t *);
se_device_t *vr_add_device_to_list (se_hba_t *, void *);
...
extern int vr_check_virtdev_params (se_devinfo_t *, struct iscsi_target *);
extern void vr_get_plugin_info (void *, char *, int *);
extern void vr_get_dev_info (se_device_t *, char *, int *);
int vr_check_lba (unsigned long long, se_device_t *);
int vr_check_for_SG (se_task_t *);
unsigned char *vr_get_cdb (se_task_t *);
u32 vr_get_blocksize (se_device_t *);
u32 vr_get_dma_length (se_task_t *);
u32 vr_get_max_cdbs (se_device_t *);
u32 vr_get_max_sectors (se_device_t *);
u32 vr_get_queue_depth (se_device_t *);
