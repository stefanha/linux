...
extern int mc_attach_hba (iscsi_portal_group_t *, se_hba_t *, iscsi_hbainfo_t *);
...
extern se_device_t *mc_add_device_to_list (se_hba_t *, void *);
...
extern int mc_check_dev_params (se_hba_t *, struct iscsi_target *, iscsi_dev_transport_info_t *);
