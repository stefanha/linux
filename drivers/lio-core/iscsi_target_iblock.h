...
extern int iblock_CDB_inquiry (iscsi_task_t *, u32);
extern int iblock_CDB_none (iscsi_task_t *, u32);
extern int iblock_CDB_read_non_SG (iscsi_task_t *, u32);
extern int iblock_CDB_read_SG (iscsi_task_t *, u32);
extern int iblock_CDB_write_non_SG (iscsi_task_t *, u32);
extern int iblock_CDB_write_SG (iscsi_task_t *, u32);

extern int iblock_attach_hba (iscsi_portal_group_t *, iscsi_hba_t *, iscsi_hbainfo_t *);
extern int iblock_detach_hba (iscsi_hba_t *);
extern int iblock_claim_phydevice (iscsi_hba_t *, iscsi_device_t *);
extern int iblock_release_phydevice (iscsi_device_t *);
extern int iblock_create_virtdevice (iscsi_hba_t *, iscsi_devinfo_t *);
extern int iblock_activate_device (iscsi_device_t *);
extern void iblock_deactivate_device (iscsi_device_t *);
extern int iblock_check_device_location (iscsi_device_t *, iscsi_dev_transport_info_t *);
extern int iblock_check_ghost_id (iscsi_hbainfo_t *);
extern void iblock_free_device (iscsi_device_t *);
extern int iblock_transport_complete (iscsi_task_t *);
extern void *iblock_allocate_request (iscsi_task_t *, iscsi_device_t *);
extern void iblock_get_evpd_prod (unsigned char *, u32, iscsi_device_t *);
extern void iblock_get_evpd_sn (unsigned char *, u32, iscsi_device_t *);
extern int iblock_do_task (iscsi_task_t *);
extern void iblock_free_task (iscsi_task_t *);
extern int iblock_check_hba_params (iscsi_hbainfo_t *, struct iscsi_target *, int);
extern int iblock_check_dev_params (iscsi_hba_t *, struct iscsi_target *, iscsi_dev_transport_info_t *);
...
extern void iblock_get_hba_info (iscsi_hba_t *, char *, int *);
extern void iblock_get_dev_info (iscsi_device_t *, char *, int *);
extern int iblock_check_lba (unsigned long long, iscsi_device_t *);
extern int iblock_check_for_SG (iscsi_task_t *);
extern unsigned char *iblock_get_cdb (iscsi_task_t *);
extern u32 iblock_get_blocksize (iscsi_device_t *);
extern u32 iblock_get_device_rev (iscsi_device_t *);
extern u32 iblock_get_device_type (iscsi_device_t *);
extern u32 iblock_get_dma_length (u32, iscsi_device_t *);
extern u32 iblock_get_max_sectors (iscsi_device_t *);
extern u32 iblock_get_queue_depth (iscsi_device_t *);
extern unsigned char *iblock_get_non_SG (iscsi_task_t *);
