...
extern int fd_claim_phydevice (iscsi_hba_t *, iscsi_device_t *);
extern int fd_release_phydevice (iscsi_device_t *);
extern int fd_create_virtdevice (iscsi_hba_t *, iscsi_devinfo_t *);
extern int fd_activate_device (iscsi_device_t *);
extern void fd_deactivate_device (iscsi_device_t *);
extern int fd_check_device_location (iscsi_device_t *, iscsi_dev_transport_info_t *);
