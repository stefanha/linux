...
#define PARAM_DA_TASK_TIMEOUT		0x00000001
#define PARAM_DA_STATUS_THREAD		0x00000002
#define PARAM_DA_STATUS_THREAD_TUR	0x00000004
#define PARAM_DA_QUEUE_DEPTH		0x00000008
#define PARAM_DA_MAX_SECTORS		0x00000010
...
/* Used to set SE Device Attributes */
#define DA_SET_TASK_TIMEOUT		1
#define DA_SET_STATUS_THREAD		2
#define DA_SET_STATUS_THREAD_TUR	3
#define DA_SET_QUEUE_DEPTH		4
#define DA_SET_MAX_SECTORS		5
...
typedef enum {
	...
	ISCSI_TARGET_LISTDEVATTRIB	,
	ISCSI_TARGET_SETDEVATTRIB	,
