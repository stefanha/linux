...
extern void iscsi_create_conn_recovery_datain_values(struct iscsi_cmd *, u32);
...
extern void iscsi_discard_cr_cmds_by_expstatsn(struct iscsi_conn_recovery *, u32);
